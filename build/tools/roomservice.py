...
custom_local_manifest = ".repo/local_manifests/ArtStar.xml"
custom_default_revision =  os.getenv('ROOMSERVICE_DEFAULT_BRANCH', 'Q')
custom_dependencies = "asop.dependencies"
org_manifest = "ArtStarOS-devices"  # leave empty if org is provided in manifest
org_display = "ArtStarOS-Devices"  # needed for displaying
